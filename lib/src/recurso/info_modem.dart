import 'package:app_registro_info_empresa/src/empresa/empresa.dart';
...
class InfoModem extends StatelessWidget {
  const InfoModem({Key key}) : super(key: key);
          ...
          appBar: AppBar(
            ...
            actions: <Widget>[
              Padding(
                ...
                child: Image.asset('img/modem.png'),
              )
            ],
          ),
          body: Stack(
